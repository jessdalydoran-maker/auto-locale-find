...
const INTENT_TO_CATEGORIES: Record<string, string[]> = {
  ...
  "nature": ["parks", "attractions", "tours", "things-to-do"],
  "hiking": ["parks", "attractions", "tours"],
  "walks": ["parks", "tours", "attractions"],
  "walking": ["parks", "tours", "attractions"],
  "adventure": ["escape-rooms", "leisure-entertainment", "tours", "things-to-do"],
  "adventure activities": ["escape-rooms", "leisure-entertainment", "tours", "things-to-do"],
  "culture": ["museums", "theatre", "tours", "attractions"],
  "heritage": ["museums", "tours", "attractions"],
  "wellness": ["gyms", "leisure-centres"],
  "spa": ["hotels", "accommodation"],
