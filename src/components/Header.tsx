      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <Link to="/roam" className="px-3 py-2 text-sm text-foreground/70 hover:text-foreground transition-colors rounded-md font-medium">
              ROAM
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden pb-4 animate-fade-in border-t border-border pt-3 max-h-[calc(100vh-4rem)] overflow-y-auto">
            <nav className="flex flex-col gap-0.5">
              ...
              <Link to="/roam" className="px-2 py-2.5 text-sm text-foreground/70 hover:text-foreground transition-colors" onClick={() => setMobileMenuOpen(false)}>ROAM</Link>
